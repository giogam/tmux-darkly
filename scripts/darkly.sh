...
main()
{
  ...
  show_battery=$(get_tmux_option "@darkly-show-battery" false)
  show_network=$(get_tmux_option "@darkly-show-network" false)
  ...
  show_cpu_usage=$(get_tmux_option "@darkly-cpu-usage" false)
